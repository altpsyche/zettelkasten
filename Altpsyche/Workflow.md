...
**5. Fleeting notes expire.** Process within a week or delete. A fleeting note you keep "just in case" is clutter you will never read.

**6. The slip-box stays flat.** Never make subfolders in `04. Zettelkasten`. Structure comes from links and MOCs, not from directories.

**7. Write the note you would need in five years,** not the one that makes sense today with the source still open.
